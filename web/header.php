...
<html>
    <head>    
        ...
        <link rel="stylesheet" href="<?= WEB_URL?>assets/css/search.css">
        <link rel="stylesheet" href="<?= WEB_URL?>assets/css/header.css">
        <link rel="stylesheet" href="<?= WEB_URL?>assets/css/movies-details.css">
        <link rel="stylesheet" href="<?= WEB_URL?>assets/css/listing-movies.css">
        <link rel="stylesheet" href="<?= WEB_URL?>assets/css/footer.css">
    ...
    <body>
        <div class="header">
            <figure class="logo-container">
                <a href="<?= WEB_URL?>">
                    <img src="<?= WEB_URL?>assets/images/logo-quikdevflix.png" alt="QuikDev Flix Logo">
                </a>            
            </figure>
